...
"<button type='button' onclick='togglePassword(\"wifi_password\", \"wifiToggleBtn\")' id='wifiToggleBtn' style='padding:12px 16px;background:#6c757d;color:white;border:none;border-radius:5px;font-size:14px;cursor:pointer;white-space:nowrap;'>显示</button>"
"</div>"
"</div>"
"<div class='form-group'>"
...
"<button type='button' onclick='togglePassword(\"mqtt_password\", \"mqttToggleBtn\")' id='mqttToggleBtn' style='padding:12px 16px;background:#6c757d;color:white;border:none;border-radius:5px;font-size:14px;cursor:pointer;white-space:nowrap;'>显示</button>"
"</div>"
"</div>"
"<div class='buttons'>"
